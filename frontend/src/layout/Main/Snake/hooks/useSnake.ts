...
import {
  setCells,
  startGame
} from '../../../../store/schulteTableReducer/schulteTableReducer'
import {
  addSnakePosition,
  createFood,
  DirectionValues,
  ...
  setXPos,
  setYPos
} from '../../../../store/snakeReducer/snakeReducer'
...
export const useSnake = () => {
  ...
  const updatePosition = () => {
    ...
    const collision =
      downCollision || upperCollision || rightCollision || leftCollision
  ...
  return { gridSize, cells, isTimeRunning, messageText, playBtnOnClick }
}
